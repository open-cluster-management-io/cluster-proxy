...
func init() {
	buildInfo := metrics.NewGaugeVec(
		&metrics.GaugeOpts{
			Name: "open_cluster_management_cluster_proxy_addon_build_info",
			Help: "A metric with a constant '1' value labeled by major, minor, git commit & git version from which Open Cluster Management cluster-proxy-addon was built.",
		},
