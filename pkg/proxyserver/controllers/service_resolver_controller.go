...
func (c *ServiceResolverReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&proxyv1alpha1.ManagedProxyServiceResolver{}). //nolint:staticcheck // SA1019 deprecated but still in use
		Watches(
			&proxyv1alpha1.ManagedProxyServiceResolver{}, //nolint:staticcheck // SA1019 deprecated but still in use
